$(document).ready(function()
{
	...
	$('#fireplace').click(function(){
		if($(this).hasClass('active') == true)
		{
			...
			$('.change_table tr').eq(1).children().text('');

			$('.change_table_pdf tr').eq(1).children().text('');
			...
			$('.change_table tr').eq(1).children().eq(0).text(code);
			$('.change_table tr').eq(1).children().eq(1).text(option_name);
			$('.change_table tr').eq(1).children().eq(2).text('This is the description of this option name it goes here.');
			//$('.change_table tr').eq(1).children().eq(3).text('$'+price);

			$('.change_table_pdf tr').eq(1).children().eq(0).text(code);
			$('.change_table_pdf tr').eq(1).children().eq(1).text(option_name);
			$('.change_table_pdf tr').eq(1).children().eq(2).text('This is the description of this option name it goes here.');
	...
	$('#diningroom').click(function(){
		if($(this).hasClass('active') == false)
		{
			...
			option_name = $('span label', $(this)).eq(1).text();
			price = $('span label', $(this)).eq(2).text();
			$('.change_table tr').eq(2).children().eq(0).text(code);
			$('.change_table tr').eq(2).children().eq(1).text(option_name);
			$('.change_table tr').eq(2).children().eq(2).text('This is the description of this option name it goes here.');
			//$('.change_table tr').eq(2).children().eq(3).text('$'+price);


			$('.change_table_pdf tr').eq(2).children().eq(0).text(code);
			$('.change_table_pdf tr').eq(2).children().eq(1).text(option_name);
			$('.change_table_pdf tr').eq(2).children().eq(2).text('This is the description of this option name it goes here.');
		}
	...
	$('#study').click(function(){
		if($(this).hasClass('active') == false)
		{
			...
			option_name = $('span label', $(this)).eq(1).text();
			price = $('span label', $(this)).eq(2).text();
			$('.change_table tr').eq(3).children().eq(0).text(code);
			$('.change_table tr').eq(3).children().eq(1).text(option_name);
			$('.change_table tr').eq(3).children().eq(2).text('This is the description of this option name it goes here.');
			//$('.change_table tr').eq(3).children().eq(3).text('$'+price);

			$('.change_table_pdf tr').eq(3).children().eq(0).text(code);
			$('.change_table_pdf tr').eq(3).children().eq(1).text(option_name);
			$('.change_table_pdf tr').eq(3).children().eq(2).text('This is the description of this option name it goes here.');
		}
